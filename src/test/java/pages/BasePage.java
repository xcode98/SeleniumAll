...
public class BasePage {
    ...
    public void seleccionandoElContenidoDeUnComboBoxByValue(String locator,String valueToSelect){
        Select dropdown = new Select(Find(locator));
        dropdown.selectByValue(valueToSelect);
    }

    public void seleccionandoElContenidoDeUnComboBoxByIndex(String locator,int valueToSelect){
        Select dropdown = new Select(Find(locator));
